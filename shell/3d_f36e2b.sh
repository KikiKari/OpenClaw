...
#
# DESCRIPTION
# Dieses Skript erzeugt eine interaktive 3D-Architekturvisualisierung des Secret-Vault-Systems,
# indem es die Funktionalität von der ursprünglichen HTML/JavaScript-Implementierung in ein
# Bash-Skript portiert, das eine HTML-Datei generiert.
#
# PARAMETER
# $1 - Der Dateipfad, unter dem die generierte HTML-Datei gespeichert wird.
#
# EXAMPLE
# ./generate_3d_visualization.sh "/tmp/3d.html"
...
read -r -d '' htmlContent <<'HTML_CONTENT_END'
<!DOCTYPE html>
<html lang="de">
<head>
<meta charset="utf-8">
...
echo "$htmlContent" > "$OUTPUT_PATH"

echo "HTML file generated successfully at: $OUTPUT_PATH"
