...
# HTML-Grundstruktur erzeugen
{
  ...
  echo '    <meta name="description" content="Lokaler Regen-Check für die nächsten 30, 60 und 120 Minuten" />'
  echo '    <meta name="apple-mobile-web-app-capable" content="yes" />'
  echo '    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />'
  echo '    <meta name="apple-mobile-web-app-title" content="Weather" />'
  echo '    <link rel="manifest" href="./manifest.json" />'
  echo '    <link rel="apple-touch-icon" href="./icon-512.png" />'
  echo '    <title>Weather – Regen-Check</title>'
  echo '    <script type="module" crossorigin src="./assets/index-DGdzG44S.js"></script>'
  echo '    <link rel="stylesheet" crossorigin href="./assets/index-erFv57XC.css">'
  echo '  </head>'
  echo '  <body>'
  echo '    <div id="root"></div>'
  echo '  <script data-pplx-inline-edit>'
