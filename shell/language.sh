...
# Generate 404 error page for Raku Documentation website
# This script creates an HTML document that displays a 404 error page
# with appropriate styling and navigation elements
...
echo "404 page generated successfully at $OUTPUT_FILE"
