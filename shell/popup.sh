...
# TikTok Live Companion HTML Generator
# This script generates the popup.html file for the TikTok Live Companion extension
...
# Generate HTML and write to specified file
generate_html > "$1"
