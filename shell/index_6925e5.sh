...
# Erstelle index.html mit dem übergebenen Dateinamen
# Aufruf: ./script.sh dateiname.html

if [ $# -ne 1 ]; then
    echo "Verwendung: $0 dateiname.html" >&2
    exit 1
fi
...
echo "Datei '$output_file' erfolgreich erstellt."
