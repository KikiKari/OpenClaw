...
cat > "$spec_file" << 'JSON_SPEC'
{"kanten":[{"art":"fluss","nach":"github","von":"abfrage-beim-oeffnen"},{"art":"fluss","nach":"vercel","von":"localstorage"},{"art":"fluss","nach":"docker-hub","von":"keine-vorbelegung"},{"art":"fluss","nach":"fetch-je-quelle","von":"github"},{"art":"fluss","nach":"cors-pruefung","von":"vercel"},{"art":"fluss","nach":"fehler-isolieren","von":"docker-hub"},{"art":"fluss","nach":"fetch-je-quelle","von":"openrouter"},{"art":"fluss","nach":"cors-pruefung","von":"openai"},{"art":"fluss","nach":"fehler-isolieren","von":"anthropic"},{"art":"fluss","nach":"fetch-je-quelle","von":"tailscale"},{"art":"fluss","nach":"cors-pruefung","von":"clawhub"},{"art":"fluss","nach":"kacheln","von":"fetch-je-quelle"},{"art":"fluss","nach":"verbrauch","von":"cors-pruefung"},{"art":"fluss","nach":"keine-daten-hinweis","von":"fehler-isolieren"}],"kantenarten":[{"art":"fluss","farbe":"#0f766e","stil":"voll","text":"Fluss von unten nach oben"}],"schichten":[{"blocks":[{"id":"abfrage-beim-oeffnen","name":"Abfrage beim Oeffnen","untertitel":"kein Vorbelegen"},{"id":"localstorage","name":"localStorage","untertitel":"nur lokal"},{"id":"keine-vorbelegung","name":"keine Vorbelegung","untertitel":"leer geliefert"}],"farbe":"#5f6773","name":"Tokens"},{"blocks":[{"id":"github","name":"GitHub","untertitel":"Repos, Kontingent"},{"id":"vercel","name":"Vercel","untertitel":"Deployments"},{"id":"docker-hub","name":"Docker Hub","untertitel":"Abbilder"},{"id":"openrouter","name":"OpenRouter","untertitel":"Guthaben"},{"id":"openai","name":"OpenAI","untertitel":"Admin-Key"},{"id":"anthropic","name":"Anthropic","untertitel":"Admin-Key"},{"id":"tailscale","name":"Tailscale","untertitel":"Geraete"},{"id":"clawhub","name":"ClawHub","untertitel":"Skills"}],"farbe":"#2481cc","name":"Quellen"},{"blocks":[{"id":"fetch-je-quelle","name":"fetch je Quelle","untertitel":"direkt"},{"id":"cors-pruefung","name":"CORS-Pruefung","untertitel":"entscheidet"},{"id":"fehler-isolieren","name":"Fehler isolieren","untertitel":"je Kachel"}],"farbe":"#6d5bd0","name":"Abruf"},{"blocks":[{"id":"kacheln","name":"Kacheln","untertitel":"ein Blick"},{"id":"verbrauch","name":"Verbrauch","untertitel":"Zahlen"},{"id":"keine-daten-hinweis","name":"keine Daten = Hinweis","untertitel":"mit Grund"}],"farbe":"#0f766e","name":"Ausgabe"}]}
JSON_SPEC

html_template=$(mktemp)
trap 'rm -f "$html_template"' EXIT

cat > "$html_template" << 'HTML_TEMPLATE'
<!DOCTYPE html>
<html lang="de">
<head>
<meta charset="utf-8">
...
json_spec=$(cat "$spec_file")
html_content=$(sed "s|%s|$json_spec|g" "$html_template")
