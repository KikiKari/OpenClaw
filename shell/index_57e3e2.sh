...
# Dieses Skript erzeugt eine HTML-Datei mit dem Inhalt der index.html
# Es akzeptiert einen Parameter für den Dateinamen
...
echo "HTML-Datei wurde erfolgreich erstellt: $DATEINAME"
