...
def veroeffentlichen(nachricht: str) -> None:
    """
    Uebertraegt neue Erzeugnisse in den Branch gateway2-abstractions.
    ...
    ergebnis = _git("push", url, "HEAD:gateway2-abstractions", verzeichnis=ABSTRACTIONS_REPO)
    if ergebnis.returncode == 0:
        logger.info("Nach OpenClaw@gateway2-abstractions veroeffentlicht")
    else:
