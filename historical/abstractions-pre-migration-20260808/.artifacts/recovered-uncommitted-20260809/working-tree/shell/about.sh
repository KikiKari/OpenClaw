...
# about.sh - Generates the about.html documentation page
# Usage: ./about.sh <output-file>

output_file="${1:-about.html}"
...
<h3 id="about_calculated_properties"><a href="about_calculated_properties?view=powershell-
