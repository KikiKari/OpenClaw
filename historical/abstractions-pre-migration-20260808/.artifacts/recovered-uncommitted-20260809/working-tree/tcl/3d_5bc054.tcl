...
# Portierung von 3d.html zu Tcl 8.6
...
proc write_3d_html {filename} {
    ...
    puts $fp {<title>Tagesstatus Live Public — Interaktive Architektur</title>}
    puts $fp {<meta name="description" content="Acht Dienste, ein Blick: Tokens, Abruf, Kacheln — drehen, zoomen, Knoten auswählen.">}
    puts $fp {<meta name="theme-color" content="#0f766e">}
    puts $fp {<style>}
    puts $fp {  :root\{}
    puts $fp {    --bg:#fbfaf7; --panel:#fff; --line:#e6e3dc; --text:#16191d; --muted:#5f6773;}
    puts $fp {    --ac:#0f766e; --buehne:#0e1420; --buehne-line:#1d2739;}
    ...
    puts $fp {  <p class="lede">Acht Dienste, ein Blick: Tokens, Abruf, Kacheln — drehen, zoomen, Knoten auswählen.</p>}
    puts $fp {}
