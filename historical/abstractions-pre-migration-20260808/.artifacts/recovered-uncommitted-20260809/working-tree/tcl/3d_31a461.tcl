...
proc write_3d_html {filename} {
    ...
    puts $fp {<title>TikTok LIVE Companion iOS — Interaktive Architektur</title>}
    puts $fp {<meta name="description" content="Die Schichtsicht der iOS-App: WKWebView, Brücke, SwiftUI, ShazamKit.">}
    ...
    puts $fp {  <h1>TikTok LIVE Companion iOS</h1>}
    puts $fp {  <p class="lede">Die Schichtsicht der iOS-App: WKWebView, Brücke, SwiftUI, ShazamKit.</p>}
    puts $fp {}
