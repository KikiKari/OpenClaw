...
<#
.SYNOPSIS
    Generates the Telegram Monitor HTML page.
.DESCRIPTION
    This script generates an HTML document for the Telegram Monitor project.
    It can output to the console or save to a file if a path is provided.
.PARAMETER OutputPath
    Optional path to save the generated HTML file.
#>
...
# Define the HTML content using PowerShell here-strings and string interpolation
$htmlContent = @"
<!DOCTYPE html>
<html lang="de">
<head>
