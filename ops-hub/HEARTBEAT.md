...
## Bei Problemen
- API und Gateway immer Agent knecht informieren: Gateway exec `/home/openclaw/.npm-global/bin/openclaw doctor --yes`, `/home/openclaw/.npm-global/bin/openclaw status`, `/home/openclaw/.npm-global/bin/openclaw gateway status`, `/home/openclaw/.npm-global/bin/openclaw nodes status`.
- API und Gateway Wartung: Gateway exec `/home/openclaw/.npm-global/bin/openclaw doctor --fix --yes`.
