...
// Prüfen ob OutputPath übergeben wurde
if (process.argv.length < 3) {
  console.error('Fehler: Kein Ausgabepfad angegeben.');
  console.log('Verwendung: node 3d.js <Ausgabepfad>');
  process.exit(1);
}

const outputPath = process.argv[2];

// HTML-Inhalt als Template-String
...
try {
  ...
  console.log(`HTML-Datei erfolgreich generiert unter: ${outputPath}`);
} catch (error) {
