#!/usr/bin/env node
// 1781743218784_0e4dc0_4857ff_c17f4b.ps1 — portiert nach javascript
...
.EXAMPLE
    node script.js secret-vault.html
*/
...
try {
    ...
    console.error(`Failed to generate HTML file: ${error.message}`);
    process.exit(1);
}
