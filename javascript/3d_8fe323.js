...
function create3DVisualization(outputPath) {
...
(function(){
  ...
  console.log(`3D visualization HTML written to ${outputPath}`);
}

// Main execution
if (require.main === module) {
  const outputPath = process.argv[2] || '3d-visualization.html';
  create3DVisualization(outputPath);
}

module.exports = { create3DVisualization };
