#!/usr/bin/env node
// 1781743218784_0e4dc0_38b5b2.tcl — portiert nach javascript
...
function main(argv) {
    if (argv.length !== 1) {
        console.error("Usage: " + __filename + " <output-file>");
        process.exit(1);
    }
    ...
    try {
        ...
        console.error("Could not open file '" + outputFile + "' for writing: " + error.message);
        process.exit(1);
    }
}
