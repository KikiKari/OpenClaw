#!/usr/bin/env node
// 1781743218784_0e4dc0_38b5b2.py — portiert nach javascript
// Quelle: python, Projects@abstractions:python/1781743218784_0e4dc0_38b5b2.py
...
function main() {
  ...
  if (args.length !== 1) {
    console.error(`Usage: ${path.basename(process.argv[1])} <output-file>`);
    process.exit(1);
  }
