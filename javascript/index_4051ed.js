...
function generateHTML() {
  const html = createElement('html', { lang: 'de' }, [
    createElement('head', {}, [
      ...
      createElement('title', {}, [createTextNode('Telegram Monitor')]),
      createElement('style', {}, [createTextNode(`  :root{
  ...
  .ev .k.start{color:#fe2c55} .ev .k.end{color:var(--muted)
    ...
    createElement('body', {}, [
      createElement('header', {}, [
        createElement('h1', {}, [createTextNode('Telegram Monitor')]),
        createElement('span', { id: 'statusPills', class: 'row', style: 'margin:0;gap:6px' }),
        createElement('button', { id: 'notifyBtn', style: 'margin-left:auto;font:inherit;font-weight:600;border:1px solid var(--line);background:var(--bg);color:var(--text);border-radius:8px;padding:6px 12px;cursor:pointer' }, [createTextNode('Meldungen erlauben')]),
        createElement('button', { id: 'installBtn', hidden: true, style: 'font:inherit;font-weight:600;\n          border:1px solid #2481cc;background:#2481cc;color:#fff;border-radius:8px;\n          padding:6px 12px;cursor:pointer' }, [createTextNode('Als App installieren')])
      ]),
      createElement('nav', {}, [
        createElement('button', { 'data-tab': 'live', class: 'active' }, [createTextNode('Live')]),
        createElement('button', { 'data-tab': 'search' }, [createTextNode('Suche')]),
        createElement('button', { 'data-tab': 'watch' }, [createTextNode('Watchlist')]),
        createElement('button', { 'data-tab': 'tiktok' }, [createTextNode('TikTok')]),
        createElement('button', { 'data-tab': 'discord' }, [createTextNode('Discord')]),
        createElement('button', { 'data-tab': 'status' }, [createTextNode('Status')])
      ]),
      createElement('main', {}, [
        createElement('section', { class: 'panel active', id: 'panel-live' }, [
          createElement('div', { class: 'row' }, [
            createElement('label', { class: 'hint', style: 'margin:0' }, [createTextNode('Aktualisierung alle')]),
            createElement('select', { id: 'liveEvery' }, [
              createElement('option', { value: '30' }, [createTextNode('30 Sekunden')]),
              createElement('option', { value: '60', selected: true }, [createTextNode('1 Minute')]),
              createElement('option', { value: '300' }, [createTextNode('5 Minuten')]),
              createElement('option', { value: '0' }, [createTextNode('nur manuell')])
            ]),
            createElement('button', { class: 'go sec', id: 'btnPollNow' }, [createTextNode('Jetzt abrufen')]),
            createElement('span', { class: 'hint', id: 'liveState', style: 'margin:0' })
          ]),
          createElement('p', { class: 'hint' }, [createTextNode('Zeigt den fortlaufenden Verlauf aller Kanaele auf der Watchlist.\n      Der Server fragt im Hintergrund selbstaendig ab; diese Ansicht holt den\n      gesammelten Verlauf. Neue Beitraege werden markiert.')]),
        ...
        createElement('section', { class: 'panel', id: 'panel-search' }, [
          createElement('div', { class: 'row' }, [
            ...
            createElement('select', { id: 'limit' }, [
              createElement('option', {}, [createTextNode('10')]),
              createElement('option', { selected: true }, [createTextNode('20')]),
              createElement('option', {}, [createTextNode('40')])
            ]),
            createElement('button', { class: 'go', id: 'btnSearch' }, [createTextNode('Suchen')])
          ]),
          createElement('p', { class: 'hint' }, [createTextNode('Sucht ueber alle aktiven Methoden gleichzeitig: oeffentliche t.me-Vorschau,\n      Namensvarianten, Websuche, optional Bot-API / MTProto sowie Discord-Invites.')]),
          createElement('div', { id: 'searchOut' })
        ]),
        createElement('section', { class: 'panel', id: 'panel-watch' }, [
          createElement('div', { class: 'row' }, [
            createElement('select', { id: 'wPlatform' }, [
              createElement('option', { value: 'telegram' }, [createTextNode('Telegram')]),
              createElement('option', { value: 'discord' }, [createTextNode('Discord')])
            ]),
            ...
            createElement('button', { class: 'go', id: 'btnAdd' }, [createTextNode('Hinzufuegen')]),
            createElement('button', { class: 'go sec', id: 'btnScan' }, [createTextNode('Uebersicht laden')])
          ]),
        ...
        createElement('section', { class: 'panel', id: 'panel-tiktok' }, [
          createElement('div', { class: 'row' }, [
            ...
            createElement('button', { class: 'go', id: 'btnTtCheck' }, [createTextNode('Status prüfen')]),
            createElement('button', { class: 'go sec', id: 'btnTtWatch' }, [createTextNode('Beobachten')]),
            createElement('label', { class: 'hint', style: 'margin:0' }, [
              createElement('input', { type: 'checkbox', id: 'ttEmbed', checked: true }),
              createTextNode('\n        Player einblenden, wenn live')
            ])
          ]),
          createElement('p', { class: 'hint' }, [createTextNode('Zeigt Live-Status, laufende Sendung und die letzten Sendungen.\n      Der Player ist der offizielle TikTok-Embed — ohne Anmeldung, ohne Geschenk-\n      und Kauf-Oberfläche. Beobachtete Konten meldet der Poller beim Livegang.')]),
          createElement('div', { id: 'ttOut' }),
          createElement('h3', { style: 'font-size:13px;text-transform:uppercase;letter-spacing:.04em;color:var(--muted);margin:22px 0 8px' }, [createTextNode('Ereignisse')]),
        ...
        createElement('section', { class: 'panel', id: 'panel-discord' }, [
          createElement('div', { class: 'row' }, [
            ...
            createElement('button', { class: 'go dc', id: 'btnInvite' }, [createTextNode('Invite pruefen')]),
            createElement('button', { class: 'go sec', id: 'btnGuilds' }, [createTextNode('Server des Bots')])
          ]),
          createElement('p', { class: 'hint' }, [createTextNode('Invite-Pruefung funktioniert ohne Token. Server, Kanaele und Nachrichten\n      brauchen einen Bot-Token (\n      DISCORD_BOT_TOKEN\n      ).')]),
      ...
      createElement('script', {}, [createTextNode(`
