...
# Tcl script to generate CSS content and write it to a file
# This script mimics the structure of the original CSS by building the content programmatically
...
@media (prefers-reduced-motion: reduce) { * { scroll-behavior: auto !important; } }
    ...
    set cssContent [string trimleft $cssContent "\n"]
    
    # Write to file
    set fh [open $filename w]
    puts -nonewline $fh $cssContent
    close $fh
}
