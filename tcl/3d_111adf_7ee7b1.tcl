...
# Entferne führende Leerzeichen (da Tcl das hier-Dokument nicht automatisch einrückt)
regsub -all {^\s+} $htmlContent {} htmlContent
...
puts "HTML file created at: $OutputPath"
