...
# Generiert die 3D-Architekturvisualisierungs-HTML-Datei für Python Hardener.
# Dieses Skript erstellt ein interaktives 3D-Diagramm, das den Fluss zwischen Komponenten zeigt.

proc generate_html {output_path} {
...
proc main {} {
    ...
    if {$::argc != 1} {
        puts "Usage: tclsh 3d.tcl <output_file>"
        exit 1
    }
    
    set output_path [lindex $::argv 0]
    generate_html $output_path
    puts "Generated 3D visualization HTML file: $output_path"
}
