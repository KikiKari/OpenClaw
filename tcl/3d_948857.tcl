...
proc write_3d_html {filename} {
    ...
    puts $fp {<title>tt-live — Interaktive Architektur</title>}
    puts $fp {<meta name="description" content="Vom @handle zum Ereignis: Auflösung, Prüfung, Daemon — drehen, zoomen, Knoten auswählen.">}
    ...
    puts $fp {  <h1>tt-live</h1>}
    puts $fp {  <p class="lede">Vom @handle zum Ereignis: Auflösung, Prüfung, Daemon — drehen, zoomen, Knoten auswählen.</p>}
    puts $fp {}
