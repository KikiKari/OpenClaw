...
# Define the specification data structure
...
# HTML template with placeholder for JSON spec
...
set html [string map [list "%s" $json_spec] $html_template]

# Get filename from command line argument or default to '3d.html'
if {$argc > 0} {
