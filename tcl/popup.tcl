...
# Tcl/Tk port of popup.html - TikTok Live Companion
# This script generates the HTML structure and writes it to a file

proc generate_popup_html {} {
    set html {}
...
set html_content [generate_popup_html]
