...
# Tcl/Tk port of the HTML/JavaScript Secret Vault application
# This script generates the HTML file when run with a filename argument
...
puts "HTML file generated: $outfile"
