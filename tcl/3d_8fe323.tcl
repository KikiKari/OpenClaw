...
proc generateHtml {filename} {
    ...
    puts $html {<title>Abstractions Manager — Interaktive Architektur</title>}
    puts $html {<meta name="description" content="Von OpenClaw-Scripts in zehn Zielsprachen — drehen, zoomen, Knoten auswählen.">}
    puts $html {<meta name="theme-color" content="#0f766e">}
    puts $html {<style>}
    puts $html {  :root\{}
    puts $html {    --bg:#fbfaf7; --panel:#fff; --line:#e6e3dc; --text:#16191d; --muted:#5f6773;}
    puts $html {    --ac:#0f766e; --buehne:#0e1420; --buehne-line:#1d2739;}
    ...
    puts $html {  <h1>Abstractions Manager</h1>}
    puts $html {  <p class="lede">Von OpenClaw-Scripts in zehn Zielsprachen — drehen, zoomen, Knoten auswählen.</p>}
    puts $html {}
