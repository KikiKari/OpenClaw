#!/usr/bin/env tclsh
# 1781743218784_0e4dc0_4857ff_36a169.ps1 — portiert nach tcl
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_0e4dc0_4857ff_36a169.ps1
...
# Main --
#
#     Main procedure that handles command line arguments and writes HTML to file
proc Main {argv} {
    if {[llength $argv] != 1} {
