...
# ARGUMENTS
#     OutputFile - The path where the generated HTML file will be saved.
# EXAMPLE
#     tclsh script.tcl secret-vault.html
...
if {[catch {
    ...
    puts stderr "Could not write to file '$OutputFile': $errmsg"
    exit 1
}
