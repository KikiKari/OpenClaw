...
# Quelle: css, Projects@TikTok-Live-Companion:release/0.6.0/tiktok-live-companion-extension-0.6.0/sidepanel.css
# auch in: Projects@TikTok-Live-Companion:release/0.7.0/tiktok-live-companion-extension-0.7.0/sidepanel.css
...
# Portierung von sidepanel.css zu Tcl 8.6
# Dieses Skript generiert die CSS-Datei dynamisch
...
@media (prefers-reduced-motion: reduce) { * { scroll-behavior: auto !important; } }
    ...
    # Entferne führende Leerzeichen aus jeder Zeile, um korrektes CSS zu erhalten
    set lines [split $css_content \n]
    set cleaned_lines {}
    foreach line $lines {
        lappend cleaned_lines [string trimLeft $line]
    }
    set final_content [join $cleaned_lines \n]
...
# Hauptprogramm
if {$argc != 1} {
    puts "Verwendung: [info script] <ausgabedatei.css>"
    exit 1
}

set output_file [lindex $argv 0]
write_css_file $output_file
puts "CSS-Datei wurde erfolgreich erstellt: $output_file"
