...
- When generating new Perplexity keys, use descriptive token names such as `OpenClaw-GW1-Production` or `OpenClaw-GW1-Testing` because the full token is not visible after creation.
