...
Priority (free credits):
1. Firecrawl (500/month) - Crawling/Markdown
2. Tavily (1,000/month) - Deep research
3. EXA (via OpenRouter) - Quick research
4. Perplexity (via OpenRouter) - Verified facts
5. SearXNG (local) - Fallback
"""
