...
| --- | --- | --- | --- | --- |
| Cluster Gateway | v1.0.0 | 463 | ✅ Pass | `openclaw skills install cluster-gateway` |
| MCP Tool Utils | v1.0.0 | 531 | ✅ Pass | `openclaw skills install mcp-tool-utils` |
...
| Log Collector | v1.0.0 | 460 | 🔍 Review | `openclaw skills install log-collector` |
