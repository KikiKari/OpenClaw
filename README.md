...
| MCP Tool Utils | v1.0.0 | 645 | ✅ Pass | `openclaw skills install mcp-tool-utils` |
| Reports Creator | v1.0.0 | 571 | ✅ Pass | `openclaw skills install reports-creator` |
...
| Log Collector | v1.0.0 | 577 | 🔍 Review | `openclaw skills install log-collector` |
