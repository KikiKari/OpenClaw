...
| MCP Tool Utils | v1.0.0 | 649 | ✅ Pass | `openclaw skills install mcp-tool-utils` |
| Reports Creator | v1.0.0 | 575 | ✅ Pass | `openclaw skills install reports-creator` |
...
| Log Collector | v1.0.0 | 582 | 🔍 Review | `openclaw skills install log-collector` |
