...
| --- | --- | --- | --- | --- |
| Cluster Gateway | v1.0.0 | 568 | ✅ Pass | `openclaw skills install cluster-gateway` |
...
| Relay Node | v1.0.0 | 596 | ✅ Pass | `openclaw skills install relay-node` |
| JSON Utils | v1.0.0 | 636 | ✅ Pass | `openclaw skills install json-utils` |
| Log Collector | v1.0.0 | 579 | 🔍 Review | `openclaw skills install log-collector` |
