...
| --- | --- | --- | --- | --- |
| Cluster Gateway | v1.0.0 | 659 | ✅ Pass | `openclaw skills install cluster-gateway` |
| MCP Tool Utils | v1.0.0 | 754 | ✅ Pass | `openclaw skills install mcp-tool-utils` |
...
| Doc Scraper | v1.0.0 | 656 | 🔍 Review | `openclaw skills install doc-scraper` |
| Workspace Database Manager | v1.0.0 | 312 | 🔍 Review | `openclaw skills install workspace-database-manager` |
| Scripting Utils | v1.0.0 | 601 | 🔍 Review | `openclaw skills install scripting-utils` |
