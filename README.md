...
| --- | --- | --- | --- | --- |
| Cluster Gateway | v1.0.0 | 364 | ✅ Pass | `openclaw skills install cluster-gateway` |
...
| Log Collector | v1.0.0 | 374 | 🔍 Review | `openclaw skills install log-collector` |
...
| Scripting Utils | v1.0.0 | 331 | 🔍 Review | `openclaw skills install scripting-utils` |
