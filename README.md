...
| --- | --- | --- | --- | --- |
| Cluster Gateway | v1.0.0 | 308 | ✅ Pass | `openclaw skills install cluster-gateway` |
| MCP Tool Utils | v1.0.0 | 355 | ✅ Pass | `openclaw skills install mcp-tool-utils` |
...
| Log Collector | v1.0.0 | 316 | 🔍 Review | `openclaw skills install log-collector` |
...
| Scripting Utils | v1.0.0 | 283 | 🔍 Review | `openclaw skills install scripting-utils` |
