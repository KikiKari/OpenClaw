#!/usr/bin/env python3
# 1781743218784_762dc8.tcl — portiert nach python
...
const T = {{
 ...
 addField:{{de:"+ Feld",en:"+ field"}},
 del:{{de:"✕",en:"✕"}},
 newField:{{de:"neues Feld",en:"new field"}},
 newValue:{{de:"Wert",en:"value"}}
}};
const tr=k=>T[k][L];
// apply static i18n
...
</html>""".format(json.dumps(artifact_meta, ensure_ascii=False))
