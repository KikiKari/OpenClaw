...
# 1781743218784.py — portiert nach python
...
def generate_html(output_file):
    ...
    Args:
        output_file (str): Der Pfad zur zu erstellenden HTML-Ausgabedatei.
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Generiert die HTML-Datei für das Secret-Vault Public Tool.",
        epilog="Beispiel: ./script.py ./vault.html"
    )
    parser.add_argument(
        "output_file",
        help="Der Pfad zur zu erstellenden HTML-Ausgabedatei."
    )
