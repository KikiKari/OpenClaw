...
def main():
    parser = argparse.ArgumentParser(description='Generate TikTok Live Companion viewer HTML')
    parser.add_argument('output_file', nargs='?', default='viewer.html',
                        help='Output file path (default: viewer.html)')
