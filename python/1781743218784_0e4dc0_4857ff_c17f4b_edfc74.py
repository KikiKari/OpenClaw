#!/usr/bin/env python3
# 1781743218784_0e4dc0_4857ff_c17f4b.ps1 — portiert nach python
...
def main():
    parser = argparse.ArgumentParser(description='Generates an HTML file containing a Secret Vault Public web application.')
    parser.add_argument('output_file', help='The path where the generated HTML file will be saved.')
    ...
    try:
        ...
        print(f"Failed to generate HTML file: {e}", file=sys.stderr)
        sys.exit(1)
