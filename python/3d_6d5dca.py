...
"""
Generates the 3D architecture visualization HTML document for TikTok LIVE Companion.
This script creates a complete HTML file with embedded CSS and JavaScript that
visualizes the architecture using three.js.
"""
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python3 3d.py <output_file_path>")
        sys.exit(1)
