...
<#
.SYNOPSIS
Generates an HTML file for the "Tagesstatus Live Public" dashboard.

.DESCRIPTION
This script generates an HTML file containing a dashboard for monitoring various services like GitHub, OpenRouter, OpenAI, Anthropic, Tailscale, and ClawHub. It includes interactive elements for managing API keys and displaying status information.

.PARAMETER OutputPath
The path where the generated HTML file will be saved.

.EXAMPLE
.\Generate-Dashboard.ps1 -OutputPath "C:\temp\dashboard.html"
#>
