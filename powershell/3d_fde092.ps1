...
.DESCRIPTION
This script creates a self-contained HTML file that visualizes a cryptographic
architecture using Three.js. It includes interactive controls for zooming,
rotating, and selecting nodes in the 3D scene.

.PARAMETER OutputPath
The path where the HTML file will be saved. If not specified, it defaults to "3d.html".
