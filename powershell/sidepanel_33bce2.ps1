...
.DESCRIPTION
This script creates the complete HTML structure for the sidepanel interface,
including all sections, elements, and attributes as defined in the original HTML.
