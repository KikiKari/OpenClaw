...
.DESCRIPTION
This script creates a self-contained HTML file that visualizes software architecture in 3D using Three.js.
The visualization includes layers, components, and connections between them.

.PARAMETER OutputPath
The path where the HTML file will be saved. If not specified, "3d.html" will be used.
