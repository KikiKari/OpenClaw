#!/usr/bin/env pwsh
# 3d_44b946.pl — portiert nach powershell
...
# In Datei schreiben
try {
    $html | Out-File -FilePath $Ausgabedatei -Encoding UTF8 -ErrorAction Stop
    Write-Output "HTML-Datei wurde erfolgreich in '$Ausgabedatei' gespeichert."
} catch {
    Write-Error "Kann $Ausgabedatei nicht öffnen: $_"
    exit 1
}
