...
function Generate-Html {
    ...
    # Convert to JSON string properly formatted
    $ArtifactMetaJson = $ArtifactMeta | ConvertTo-Json -Depth 10
...
function Main {
    # Hauptfunktion
    if ($args.Count -ne 1) {
        Write-Host "Verwendung: python script.py <ausgabedatei.html>"
        exit 1
    }
