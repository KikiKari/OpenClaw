...
<#
.SYNOPSIS
Generates the 3D interactive architecture visualization HTML file for ClawHub-Git-Sync.
.DESCRIPTION
This script generates a standalone HTML file that visualizes the architecture of ClawHub-Git-Sync
in 3D using three.js. It accepts an output file path as a parameter.
...
Write-Output "HTML file generated at: $OutputFile"
