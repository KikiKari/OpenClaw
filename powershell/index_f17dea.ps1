...
<#
.SYNOPSIS
Generates an HTML file for Raku Documentation website.

.DESCRIPTION
This script generates the index.html file for the Raku Documentation website.
It accepts an optional output path parameter. If not provided, it writes to
the current directory.

.PARAMETER OutputPath
The path where the HTML file should be written. Defaults to "./index.html".

.EXAMPLE
./generate-index.ps1
Generates index.html in the current directory.

.EXAMPLE
./generate-index.ps1 -OutputPath "./output/index.html"
Generates index.html in the specified output directory.
#>
