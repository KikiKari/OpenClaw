...
<#
.SYNOPSIS
Generates the 3D architecture visualization HTML file for the MCP Server Monitor.

.DESCRIPTION
This script creates a self-contained HTML file that visualizes the MCP server architecture
using Three.js. The visualization includes interactive 3D blocks representing different
