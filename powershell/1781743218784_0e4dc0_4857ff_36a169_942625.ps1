#!/usr/bin/env pwsh
# 1781743218784_0e4dc0_4857ff_36a169.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/1781743218784_0e4dc0_4857ff_36a169.sh
...
function Main {
    ...
    if (-not $OutputFile) {
        Write-Error "Usage: $PSCommandPath <output-file>"
        exit 1
    }
