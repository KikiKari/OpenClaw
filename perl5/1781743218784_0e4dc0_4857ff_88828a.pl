...
secret-vault-generator - Generate HTML file for Secret-Vault Public

=head1 SYNOPSIS

secret-vault-generator [options] --output-file FILE
...
This program generates an HTML file for Secret-Vault Public, a client-side encrypted secret vault application.
