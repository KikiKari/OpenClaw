#!/usr/bin/perl
# 1781743218784_0e397c.tcl — portiert nach perl5
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_0e397c.tcl
...
sub main {
    ...
    eval {
        ...
        open(my $f, '>:encoding(UTF-8)', $output_file) or die "Cannot open file '$output_file': $!";
