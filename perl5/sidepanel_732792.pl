...
# Chatzeilen-Abschnitt
print $fh <<'HTML_CHAT_SECTION';
...
# Top-Chatter-Abschnitt
print $fh <<'HTML_TOP_CHATTERS_SECTION';
...
HTML_TOP_CHATTERS_SECTION

# Seiteninformationen-Abschnitt
print $fh <<'HTML_PAGE_INFO_SECTION';
...
HTML_PAGE_INFO_SECTION

# LIVE-Informationen-Abschnitt
print $fh <<'HTML_STATS_SECTION';
...
# WebSocket-Hook-Abschnitt
print $fh <<'HTML_HOOK_SECTION';
...
# Untertitel-Abschnitt
print $fh <<'HTML_CAPTION_SECTION';
...
HTML_CAPTION_SECTION

# Playersteuerung-Abschnitt
print $fh <<'HTML_PLAYER_SECTION';
...
# Songerkennung-Abschnitt
print $fh <<'HTML_SONG_SECTION';
...
# Caption-Protokoll-Abschnitt
print $fh <<'HTML_LOG_SECTION';
...
# Debugmodus-Abschnitt
print $fh <<'HTML_DEBUG_SECTION';
...
# Chat History Modal
print $fh <<'HTML_CHAT_HISTORY_MODAL';
...
HTML_CHAT_HISTORY_MODAL

# Notice
print $fh <<'HTML_NOTICE';
...
close $fh;
print "HTML file generated successfully at $output_file\n";
