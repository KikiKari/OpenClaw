...
# Portierung der Funktionalität von der ursprünglichen HTML/JavaScript-Implementierung zu Perl 5.
# Die Ausgabe wird in einen angegebenen Dateipfad geschrieben.
#
# PARAMETER OutputPath
# Der Dateipfad, unter dem die generierte HTML-Datei gespeichert wird.
#
# EXAMPLE
# perl generate_3d_visualization.pl /tmp/3d.html

my $output_path = $ARGV[0] or die "Usage: $0 <output_path>\n";

# Define the HTML content as a here-document
...
open my $fh, '>:encoding(utf8)', $output_path or die "Could not open file '$output_path': $!";
